...
def generate_launch_description():
    ...
    sm_parameters = {
        "active_transforms": os.path.join(examples_dir, 'transforms', 'active_transforms2.json'),
        "static_transforms": os.path.join(examples_dir, 'transforms', 'static_transforms2.json')
    }
    ...
    nodes = [scene_manipulation_service, camera_node, control_box,
             gripper, sp_ui, sp_operator, sp, scene_master]
